...
/* Thread-safe context for parallel pcap processing */
...
void trace_init_context(trace_context *ctx);
void trace_init_context_full(trace_context *ctx, int max_tcp_pairs);
void trace_done(void);
void trace_done_context(trace_context *ctx);
trace_context *tcptrace_create_context(void);
int tcptrace_analyze_file(trace_context *ctx, const char *filename, int num_threads);
void tcptrace_destroy_context(trace_context *ctx);
void extract_tcp_connections(trace_context *ctx);
void extract_udp_connections(trace_context *ctx);
...
void udptrace_init_context(trace_context *ctx);
void udptrace_done(void);
void udptrace_done_context(trace_context *ctx);
...
typedef struct tcp_conn_info {
    ...
    u_llong a2b_packets;
    u_llong a2b_data_bytes;
    u_llong a2b_data_pkts;
    u_llong a2b_rexmit_bytes;
    u_llong a2b_rexmit_pkts;
    u_llong a2b_unique_bytes;
    u_llong a2b_ack_pkts;
    u_llong a2b_pure_ack_pkts;
    u_llong a2b_sack_pkts;
    u_llong a2b_dsack_pkts;
    u_long a2b_mss;
    u_long a2b_max_seg_size;
    u_long a2b_min_seg_size;
    u_long a2b_win_max;
    u_long a2b_win_min;
    u_long a2b_win_zero_ct;
    u_llong a2b_win_tot;
    u_llong a2b_out_order_pkts;
    u_llong a2b_zwnd_probes;
    u_llong a2b_zwnd_probe_bytes;
    u_llong a2b_urg_data_pkts;
    u_llong a2b_urg_data_bytes;
    u_llong a2b_trunc_bytes;
    u_llong a2b_trunc_segs;
    u_llong a2b_num_sacks;
    u_long a2b_max_sack_blocks;
    u_llong a2b_num_hardware_dups;
    u_long a2b_syn_count;
    u_long a2b_fin_count;
    u_long a2b_reset_count;
    u_llong a2b_sacks_sent;

    u_long a2b_rtt_count;
    u_long a2b_rtt_min;
    u_long a2b_rtt_max;
    double a2b_rtt_sum;
    double a2b_rtt_sum2;
    u_llong a2b_rtt_dupack;
    u_llong a2b_rtt_triple_dupack;
    u_llong a2b_rtt_amback;
    u_llong a2b_rtt_cumack;
    u_llong a2b_rtt_nosample;
    u_long a2b_retr_max;
    u_long a2b_retr_min_tm;
    u_long a2b_retr_max_tm;
    double a2b_retr_tm_sum;
    double a2b_retr_tm_sum2;

    u_long a2b_initialwin_bytes;
    u_long a2b_initialwin_segs;
    u_llong a2b_stream_length;
    u_llong a2b_missed_data;
    u_llong a2b_idle_max;

    double a2b_throughput;
    double a2b_data_xmit_time;

    u_char a2b_window_scale;
    Bool a2b_f1323_ws;
    Bool a2b_f1323_ts;
    Bool a2b_fsack_req;

    u_llong b2a_packets;
    u_llong b2a_data_bytes;
    u_llong b2a_data_pkts;
    u_llong b2a_rexmit_bytes;
    u_llong b2a_rexmit_pkts;
    u_llong b2a_unique_bytes;
    u_llong b2a_ack_pkts;
    u_llong b2a_pure_ack_pkts;
    u_llong b2a_sack_pkts;
    u_llong b2a_dsack_pkts;
    u_long b2a_mss;
    u_long b2a_max_seg_size;
    u_long b2a_min_seg_size;
    u_long b2a_win_max;
    u_long b2a_win_min;
    u_long b2a_win_zero_ct;
    u_llong b2a_win_tot;
    u_llong b2a_out_order_pkts;
    u_llong b2a_zwnd_probes;
    u_llong b2a_zwnd_probe_bytes;
    u_llong b2a_urg_data_pkts;
    u_llong b2a_urg_data_bytes;
    u_llong b2a_trunc_bytes;
    u_llong b2a_trunc_segs;
    u_llong b2a_num_sacks;
    u_long b2a_max_sack_blocks;
    u_llong b2a_num_hardware_dups;
    u_long b2a_syn_count;
    u_long b2a_fin_count;
    u_long b2a_reset_count;
    u_llong b2a_sacks_sent;

    u_long b2a_rtt_count;
    u_long b2a_rtt_min;
    u_long b2a_rtt_max;
    double b2a_rtt_sum;
    double b2a_rtt_sum2;
    u_llong b2a_rtt_dupack;
    u_llong b2a_rtt_triple_dupack;
    u_llong b2a_rtt_amback;
    u_llong b2a_rtt_cumack;
    u_llong b2a_rtt_nosample;
    u_long b2a_retr_max;
    u_long b2a_retr_min_tm;
    u_long b2a_retr_max_tm;
    double b2a_retr_tm_sum;
    double b2a_retr_tm_sum2;

    u_long b2a_initialwin_bytes;
    u_long b2a_initialwin_segs;
    u_llong b2a_stream_length;
    u_llong b2a_missed_data;
    u_llong b2a_idle_max;

    double b2a_throughput;
    double b2a_data_xmit_time;

    u_char b2a_window_scale;
    Bool b2a_f1323_ws;
    Bool b2a_f1323_ts;
    Bool b2a_fsack_req;
...
typedef struct udp_conn_info {
    ...
    u_llong a2b_packets;
    u_llong a2b_data_bytes;
    u_long a2b_min_dg_size;
    u_long a2b_max_dg_size;
    double a2b_throughput;

    u_llong b2a_packets;
    u_llong b2a_data_bytes;
    u_long b2a_min_dg_size;
    u_long b2a_max_dg_size;
    double b2a_throughput;
...
typedef struct trace_context {
    ...
    int num_tcp_pairs;
    tcp_pair **ttp;
    struct ptp_snap *tcp_snap_root;
    int max_tcp_pairs;

    int num_udp_pairs;
    udp_pair **utp;
    udp_pair *udp_snap_root;
    ...
    tcp_conn_info *tcp_conns;
    int num_tcp_conns;

    udp_conn_info *udp_conns;
    int num_udp_conns;
